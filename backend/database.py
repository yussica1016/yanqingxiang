...
def _seed_event_templates(cur):
    templates = [
        ...
        ("yinyin_online", "叶枔枖上线", "special", None, '{"yinyin_online":true}', 1.0, 0, "叶枔枖来了。", None, 1),
        ("yinyin_home", "枔枔回家", "special", "ye_residence", '{"yinyin_online":true}', 1.0, 0, "叶枔枖推门进来了。拉哈拉波跑过去蹭脚踝。", None, 1),
